                          ...
                          >
                            ...
                            {reactionPickerMsg?._id === msg._id && (
                              <>
                                ...
                                />
                                <div
                                  className={`absolute -top-11 z-30 flex gap- bg-white dark:bg-[#1E293B] rounded-full shadow-lg px-2 py-1.5 border border-slate-200 dark:border-slate-700 ${isMe ? 'right-0' : 'left-0'}`}
