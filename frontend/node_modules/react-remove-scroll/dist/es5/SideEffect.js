...
function RemoveScrollSideCar(props) {
  ...
  React.useEffect(
    function () {
      if (props.inert) {
        ...
        var allow_1 = tslib_1
          .__spreadArray([props.lockRef.current], (props.shards || []).map(extractRef), true)
          .filter(Boolean);
  ...
  var shouldCancelEvent = React.useCallback(function (event, parent) {
    ...
    return (0, handleScroll_1.handleScroll)(
      cancelingAxis,
      parent,
      event,
  ...
  return React.createElement(
    ...
    removeScrollBar
      ? React.createElement(react_remove_scroll_bar_1.RemoveScrollBar, {
